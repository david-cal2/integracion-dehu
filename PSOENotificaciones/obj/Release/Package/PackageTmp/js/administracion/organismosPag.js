...
$(function () {
    ...
    $(document).ready(function () {
        ...
        //GetOrganismosEmisoresTabla();
        GetOrganismosEmisoresTablaLenght();
        GetOrganismosEmisoresTablaPaginado(1, 10);
        ...
        $('#btn-buscar').click(function (e) {
            ...
            if ($selectAdministracionPublica.val() == '' && $selectOrganismosRaiz.val() == '' &&
                ...
                setTimeout(GetOrganismosEmisoresTabla, 1, data);
            }
        });
    ...
    function GetOrganismosEmisoresTabla(data) {
        var urlFuncion = '/Administracion/GetOrganismosEmisoresTablaFiltro';

        if (data == null) {
            urlFuncion = '/Administracion/GetOrganismosEmisoresTablaPosicion';
            var data = {
                primeros: true
            };
        }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('.page-jump-to').prepend("<span style='margin-top: 5px; margin-right: 10px;'>Ir a página</span>");

                $numeroRegistros = data.lenght;
            },
            error: function (data) {
    ...
    function GetOrganismosEmisoresTablaLenght() {
        $.ajax({
            async: false,
            type: 'GET',
            contentType: 'application/json; charset=utf-8',
            url: '/Administracion/GetOrganismosEmisoresTablaLenght',
            dataType: "json",
            success: function (data) {
                $numeroRegistros = data.lenght;
            },
            error: function (data) {
                toastr.error("Error en la llamada al servicio 'GetOrganismosEmisoresTablaLenght'");
            }
        });
    }

    function GetOrganismosEmisoresTablaPaginado(paginaV, maximoV) {
        $.ajax({
            async: false,
            type: 'GET',
            contentType: 'application/json; charset=utf-8',
            url: '/Administracion/GetOrganismosEmisoresTablaPaginado',
            data: {
                pagina: paginaV,
                maximo: maximoV
            },
            ...
            error: function (data) {
                toastr.error("Error en la llamada al servicio 'GetOrganismosEmisoresTablaPaginado'");
            }
        });
    }
            ...
            _createClass(BootstrapTable, [{
                ...
                value: function initPagination() {
                    ...
                    if (opts.sidePagination !== 'server') {
                        ...
                        //opts.totalRows = $numeroRegistros;
                        opts.totalRows = 50;
                        //GetOrganismosEmisoresTablaLenght();
                    }
                    this.totalPages = 0;
                ...
                value: function updatePagination(event) {
                    ...
                    //GetOrganismosEmisoresTablaPaginado(this.options.pageNumber, this.options.pageSize);
