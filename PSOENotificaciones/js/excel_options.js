    ...
    $.fn.tableExport = function (options) {
        ...
        if (defaults.type === 'csv' || defaults.type === 'tsv' || defaults.type === 'txt') {
            ...
            $(el).filter(function () {
                ...
                if (docName === '') {
                    docName = defaults.mso.worksheetName || $table.find('caption').text() || export_fileName;
            ...
            docFile += 'table thead tr th { background-color: #E20025; color: white; }';
