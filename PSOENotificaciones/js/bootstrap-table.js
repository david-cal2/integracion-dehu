    ...
    */
    ...
    var EN = {
        ...
        formatShowingRows: function formatShowingRows(pageFrom, pageTo, totalRows, totalNotFiltered) {
            ...
            return "<span id='regPagina' class='form-label d-inline'>Notificaciones por página</span>";
        },
        ...
        _createClass(BootstrapTable, [{
            ...
            value: function initToolbar() {
                ...
                if (typeof opts.toolbar === 'string' || _typeof(opts.toolbar) === 'object') {
                    ...
                    $__default["default"](Utils.sprintf('<div class="bs-bars"></div>', this.constants.classes.pull, opts.toolbarAlign)).appendTo(this.$toolbar).append($__default["default"](opts.toolbar));
                ...
                if ((opts.search || this.showSearchClearButton) && typeof opts.searchSelector !== 'string') {
                    ...
                    var searchInputHtml = "<div class='input-icon'><input type='text' class='search form-control' placeholder='Buscar...' id='input10' value=''><i class='islc-icon icon-search' aria-hidden='true'></i></div>";
